...
type ProviderPluginClient interface {
	...
	CommitFilesChanged(ctx context.Context, in *CreateCommit_Request, opts ...grpc.CallOption) (*CreateCommit_Response, error)
}
...
func (c *providerPluginClient) CommitFilesChanged(ctx context.Context, in *CreateCommit_Request, opts ...grpc.CallOption) (*CreateCommit_Response, error) {
	out := new(CreateCommit_Response)
	err := c.cc.Invoke(ctx, "/ProviderPlugin/CommitFilesChanged", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProviderPluginServer interface {
	...
	CommitFilesChanged(context.Context, *CreateCommit_Request) (*CreateCommit_Response, error)
...
func (UnimplementedProviderPluginServer) CommitFilesChanged(context.Context, *CreateCommit_Request) (*CreateCommit_Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CommitFilesChanged not implemented")
}
...
func _ProviderPlugin_CommitFilesChanged_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateCommit_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProviderPluginServer).CommitFilesChanged(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ProviderPlugin/CommitFilesChanged",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProviderPluginServer).CommitFilesChanged(ctx, req.(*CreateCommit_Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProviderPlugin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CommitFilesChanged",
			Handler:    _ProviderPlugin_CommitFilesChanged_Handler,
		},
	},
